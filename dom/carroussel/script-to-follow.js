...
// 3. Create a function `transform(index)` to update the position of the images and backgrounds:
...
// 4. Create a function `right()` for navigating to the next slide:
